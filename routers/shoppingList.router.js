...
router.post('/:id/addUnrecognized', shoppingListController.addUnrecognizedItemToShoppingList);
router.post('/:id/remove', shoppingListController.removeItemFromShoppingList);
router.post('/:id/removeUnrecognized', shoppingListController.removeUnrecognizedItemFromShoppingList);
